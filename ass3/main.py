...
#                                 keras.layers.Conv2D(filters=6, kernel_size=(5, 5), strides=1, activation="relu"),   # 6 kernels of 5x5, stride=1
#                                 keras.layers.MaxPooling2D(pool_size=(2, 2), strides=2),                                # 2x2 kernels, stride=2
#                                 keras.layers.Conv2D(filters=16, kernel_size=(5, 5), strides=1, activation="relu"),  # 16 kernels of 5x5, stride=1
#                                 keras.layers.MaxPooling2D(pool_size=(2, 2), strides=2),                                # 2x2 kernels, stride=2
#                                 keras.layers.Conv2D(filters=120, kernel_size=(5, 5), strides=1, activation="relu"), # 120 kernels of 5x5
